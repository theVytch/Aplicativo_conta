...
import br.com.contas.activities.telas_conta.FragmentTelaContaSubtracao;
...
public class FragmentTelaContaSubtracaoTest {


    private FragmentScenario<FragmentTelaContaSubtracao> fragmentScenario;
    ...
    public void setUp() {
        ...
        fragmentScenario = FragmentScenario.launchInContainer(
                FragmentTelaContaSubtracao.class,
                null,
        ...
        fragmentScenario.onFragment(fragment -> {
            ...
            executor.execute(() -> {
                try {
                    ...
                    fragment.salvarConta(nomeDaConta, valorDaConta, data, db);
                    ...
                    Usuario usuario1 = usuarioDao.getUsuario().get();
